...
def experiment4_dijkstra(graph_size, max_edge, max_k_value):
    total_dist = {}
    # Use this graph for all of the approximations
    G = f.create_random_complete_graph(graph_size, max_edge)
...
def experiment4_bellman(graph_size, max_edge, max_k_value):
    total_dist = {}
    # Use this graph for all of the approximations
    G = f.create_random_complete_graph(graph_size, max_edge)
