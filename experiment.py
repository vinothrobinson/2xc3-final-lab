...
data = experiment1_data(final_project_part1.bellman_ford, part1.bellman_ford_approx, 10, 100, ks=[0.8, 0.9, 1])
experiment1_graph(data, 10, "Bellman-Ford", ks=[0.8, 0.9, 1])

data = experiment1_data(final_project_part1.bellman_ford, part1.bellman_ford_approx, 10, 100, ks=[0.8, 0.9, 1], lower_bound=-1000)
experiment1_graph(data, 10, "Bellman-Ford", ks=[0.8, 0.9, 1])
